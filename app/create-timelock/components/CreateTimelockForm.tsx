				...
				<div className='md:col-start-2 min-w-[548px]'>
					<div className='mb-4'>
						...
						<div className='flex items-center gap-3'>
							<input
								type='number'
								className='mt-1 block flex-1 px-3 py-2.5 rounded-lg text-sm bg-gray-100 border-transparent focus:outline-none focus:ring-2 focus:ring-offset-0 focus:bg-white focus:border-gray-300 focus:ring-black/10 transition-all duration-200 ease-in-out placeholder:text-gray-400'

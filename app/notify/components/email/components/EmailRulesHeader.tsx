...
const EmailRulesHeader: React.FC = () => {
	...
	return (
		<div className='bg-black text-white p-4 px-6 rounded-xl relative overflow-hidden'>
			...
			<div className="absolute top-1/2 right-0 -translate-y-1/2 w-50 h-40 bg-no-repeat bg-cover bg-center pointer-events-none bg-[url('/email-bg.png')]" />
		</div>
	);
};
